...
To switch it \textit{off}, just write a '0' into its \textt{brightness} entry:
...
Starting this driver will create a \texttt{/dev/g_printer} device node. This
...
from \texttt{/dev/g_printer} at the Mini2440 side. And vice versa.
