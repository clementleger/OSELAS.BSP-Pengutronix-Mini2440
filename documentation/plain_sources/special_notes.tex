...
\begin{itemize}
	\item 2.6.39, stable patch level 2 (default)
...
\begin{itemize}
	\item \textbd{configs/ptxconfig}: it is the standard one to get a small
	running embedded system. It can be used as a base for your own
	development running the Mini2440 headless.
	\item \textbd{configs/ptxconfig.qt}: this configuration is intended for
